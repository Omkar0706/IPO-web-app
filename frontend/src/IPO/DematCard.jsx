...
const DematCard = () => {
  return (
    <div className='bg-white shadow-md rounded-lg p-6 w-1/2 translate-x-1/2 py-14'>
      ...
      <h1 className='text-2xl font-semibold flex items-center justify-center mt-6'>Applying for this IPO?</h1>
      ...
      <div className='flex items-center justify-center mt-6'>
        <NavLink to="/demat-account" className='bg-[#3F52FF] text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition duration-300'>
          Open Demat Account
        </NavLink>
      </div>
    </div>
